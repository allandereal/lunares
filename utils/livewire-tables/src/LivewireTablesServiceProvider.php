...
class LivewireTablesServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Blade::directive('livewireTableStyles', function () {
            ...
            $cssUrl = asset('/vendor/allandereal'.$manifest['/livewire-tables/app.css']);
        ...
        $this->publishes([
            __DIR__.'/../resources/views' => resource_path('views/vendor/allandereal'),
        ], 'lunar.livewiretables.components');

        $this->publishes([
            __DIR__.'/../dist' => public_path('vendor/allandereal'),
